<div class="" id="main-wrapper-navbar">
    <nav id='bb_connexion_website_navbar' class="white">
        <div class="nav-wrapper">
          <a href="/home" class="brand-logo"><?= $this->Html->image('assets_bb_connexion/business_connexion_logo_transparent.png',['style'=>'width:215px;']) ?></a>
          <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="ion-android-menu bb-main-color small"></i></a>
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            <!-- Language Choosing -->
            <li class="futura-text" style="border-right:1px dotted #1a70fe; padding-right:5px;">
               <span class="french-language choosen-language pointer">FR</span>
               <span class="english-language unchoosen-language pointer">EN</span>
            </li>
            <!-- Extended Menu -->
            <li class="futura-text bb_connexion_item selected"><a href="sass.html" class="bb-main-color nav-item-size"> <?= h('Bienvenue sur le Portail') ?> </a></li>
            <li class="futura-text bb_connexion_item"><a href="#!" class="bb-main-color nav-item-size"> <?= h('Présenter sa Société') ?> </a></li>

            <li class="futura-text bb_connexion_item"><a href="#!" class="bb-main-color nav-item-size"> <?= h('Gallerie') ?> </a></li>
            <li class="futura-text bb_connexion_item"><a href="#!" class="bb-main-color nav-item-size"> <?= h('Evenements') ?> </a></li>
            <li class="futura-text bb_connexion_item"><a href="#!" class="bb-main-color nav-item-size"> <?= h('Aide & Contact') ?> </a></li>
