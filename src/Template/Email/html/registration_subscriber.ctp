						  ...
						  <tbody>
						     ...
						     <tr>
						     	 <td height="30" style="line-height:30px; font-size:17px; color:white; font-family:Helvetica;">
										...
										<?php $job = $subscriber->subscriber_job; 
											switch ($subscriber->subscriber_kind) {
												case 'personal':
													$representation = 'à titre personnel';
												break;
												
												case 'entreprise':
													$representation = 'pour le compte de votre entreprise';
												break;
											}
											$number = $subscriber->subscriber_tel;
										?>
										<?php echo 'Votre volonté de participation au meeting du 12 janvier en qualité de '.$job.' '.$representation.' au Palm Club Hotel de Cocode a bel et bien été prise en compte par notre équipe qui vous contactera au +225 '.$number.' très bientôt pour confirmer votre présence.'; ?>
						     ...
						     <tr>
						     	 <td height="30" style="line-height:30px; font-size:17px; color:#FFF;font-family:Helvetica;">
						     	    Pour plus d'information sur le meeting du 12 janvier, veuillez nous contacter au +225 07 14 52 29
						     	 </td>
						     </tr>
						     <tr>
